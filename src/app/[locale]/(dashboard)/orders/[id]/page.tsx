...
export default async function OrderDetailPage({
  ...
  const baseUrl =
    ...
    (process.env.VERCEL_URL
      ...
      : "http://localhost:3000");
  const checkoutUrl = `${baseUrl}/${params.locale}/store/${shop.slug}/checkout/${order.checkout_token}`;
  ...
  const statusBadge = () => {
    ...
    return (
      map[order.status] || <Badge variant="secondary">{order.status}</Badge>
    );
  };
            ...
            <CardContent className="text-sm">
              {order.address_city ? (
                <div className="space-y-1 text-sm">
                  <div>
                    <span className="font-medium text-muted-foreground inline-block w-24">
                      Recipient:
                    </span>{" "}
                    {order.address_name}
                  </div>
                ...
                <p className="text-muted-foreground italic">
                  Address not provided yet. Customer will fill this during
                  checkout.
                </p>
              )}
            </CardContent>
        ...
        <div className="space-y-6">
            ...
            <Card className="border-blue-200 bg-blue-50/30">
              <CardHeader>
                ...
                <p className="text-xs text-blue-700">
                  Send this link to the customer to collect their address and
                  payment.
                </p>
              </CardHeader>
          ...
          <Card>
            ...
            <CardContent className="text-sm space-y-1">
              ...
              {order.customers?.instagram && (
                <p className="text-muted-foreground">
                  IG: {order.customers.instagram}
                </p>
              )}
            </CardContent>
          </Card>
